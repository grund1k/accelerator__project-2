...
/* harmony import */ var _modules_telephone_mask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/telephone-mask */ "./js/modules/telephone-mask.js");
/* harmony import */ var _modules_telephone_mask__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_telephone_mask__WEBPACK_IMPORTED_MODULE_2__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["addValidationListeners"])();
  var smoothLinks = document.querySelectorAll('a[href^="#"]');
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_4__["setSmoothsScroll"])(smoothLinks); // ---------------------------------
...
var switchAccordion = function switchAccordion(accordion) {
...
var changeButtons = function changeButtons(button) {
...
var setAccordionClickLogic = function setAccordionClickLogic(button) {
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: addValidationListeners */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addValidationListeners", function() { return addValidationListeners; });
...
var userTelephoneInputs = document.querySelectorAll('input[data-tel-input]');
var userNameInputs = document.querySelectorAll('input[data-username-input]');
var formCheckboxes = document.querySelectorAll('input[data-checkbox-input]');
var TELEPHONE_REGEX = /(^\+7)\([0-9]{3}\)[0-9]{3}\-[0-9]{2}\-[0-9]{2}$/gm;
var TIMEOUT_FOR_VALIDATION = 5000;

var validateNameInput = function validateNameInput(element) {
  if (element.value === '') {
...
var validateTelephoneInput = function validateTelephoneInput(element) {
  if (element.value === '') {
...
var validateChecoxInput = function validateChecoxInput(element) {
  if (!element.checked) {
...
var setKeyCheckboxToggle = function setKeyCheckboxToggle(evt, element) {
...
var addValidationListeners = function addValidationListeners() {
  var _iterator = _createForOfIteratorHelper(userNameInputs),
      _step;

  try {
    var _loop = function _loop() {
      var userNameInput = _step.value;
      userNameInput.addEventListener('input', function () {
        return validateNameInput(userNameInput);
      });
    };
  ...
  var _iterator2 = _createForOfIteratorHelper(userTelephoneInputs),
      _step2;

  try {
    var _loop2 = function _loop2() {
      var userTelephoneInput = _step2.value;
      userTelephoneInput.addEventListener('input', function () {
        return validateTelephoneInput(userTelephoneInput);
      });
    };
  ...
  var _iterator3 = _createForOfIteratorHelper(formCheckboxes),
      _step3;

  try {
    var _loop3 = function _loop3() {
      var formCheckbox = _step3.value;
      formCheckbox.labels[0].addEventListener('keydown', function (evt) {
        return setKeyCheckboxToggle(evt, formCheckbox);
      });
      formCheckbox.addEventListener('change', function () {
        return validateChecoxInput(formCheckbox);
      });
    };
...
var _iterator4 = _createForOfIteratorHelper(forms),
    _step4;
...
var modalCloseSections = document.querySelectorAll('[data-close-modal]');
var modalOpen = document.querySelector('[data-open-modal]');
var body = document.querySelector('.body');
var firstFocusElement = modal.querySelector('[data-focus]');
...
var openModal = function openModal() {
  ...
  modalCloseSections.forEach(function (section) {
...
var onPhoneInput = function onPhoneInput(evt) {
  ...
  if (inputNumbersValue[0] === '9') {
    '7' + inputNumbersValue, _readOnlyError("inputNumbersValue");
  }
